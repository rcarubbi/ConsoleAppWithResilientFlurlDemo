...
public class DemoConsoleAppShould : TestBase<DemoConsoleApp>
{
    private readonly Mock<IDateTimeWrapper> _dateTimeWrapperMock = new();
    private readonly Mock<IClientA> _clientAMock = new();
    private readonly Mock<IClientB> _clientBMock = new();
    protected override DemoConsoleApp ArrangeSut()
    {
        ...
        return new DemoConsoleApp(new Arguments(configuration), LoggerFactory, _dateTimeWrapperMock.Object, _clientAMock.Object, _clientBMock.Object);
    }
